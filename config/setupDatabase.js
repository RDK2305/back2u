  ...
  try {
    ...
    if (userCount === 0) {
      ...
      `,
        [
          "S001",
          "r123@conestogac.on.ca",
          "Rudraksh",
          "Kharadi",
          "Main",
          "Mobile and Web Development",
          "$2a$10$MrPaz3lPm.YqJYcyumAHDu41Pabp9L8ynM1z0b/lCrA0HoDnNuktW",
          true,
          "security",
          "S002",
          "bishal@conestogac.on.ca",
          "Bishal",
          "Paudel",
          "Main",
          "Web Development",
      ...
      await connection.query(
        `
  INSERT INTO items 
  (title, category, description, location_found, campus, type, status, date_found, distinguishing_features, image_url, user_id) 
  VALUES
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?),
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?),
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?),
...
`,
        [
          "MacBook Pro 2021",
          "electronics",
          "Found near library, has apple sticker. Missing charger.",
          "Library Building",
          "Main",
          "found",
          "Open",
          "2026-02-08",
          "Silver, 15-inch screen",
          ...
          "Open",
          "2026-02-07",
          "Blue cover with markings",
          "https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg",
          1,

          "Student ID Card",
          "id",
          "Blue student ID card with photo.",
          "Cafeteria",
          "Waterloo",
          "found",
          "Open",
          "2026-02-09",
          "Laminated blue card",
          "https://images.pexels.com/photos/6146929/pexels-photo-6146929.jpeg",
          3,
          ...
          "Open",
          "2026-02-06",
          "Canvas material with patches",
          "https://images.pexels.com/photos/2905238/pexels-photo-2905238.jpeg",
          2,

          "Car Keys",
          "keys",
          "Ford car keys with blue keychain. Found at entrance.",
          "Main Entrance",
          "Main",
          "found",
          "Open",
          "2026-02-05",
          "Blue rubber keychain",
          "https://images.pexels.com/photos/3807329/pexels-photo-3807329.jpeg",
          4,

          "Wireless Earbuds",
          "electronics",
          "Apple AirPods Pro. Found in gym.",
          "Gymnasium",
          "Cambridge",
          "found",
          "Open",
          ...
          "textbook",
          "Lab notebook for CHM 201. Contains experiments.",
          "Science Building",
          "Main",
          "found",
          "Open",
          "2026-02-03",
          "Spiral bound, black cover",
          "https://images.pexels.com/photos/590493/pexels-photo-590493.jpeg",
          1,

          "Black Leather Jacket",
          "clothing",
          "XL black leather jacket. Found in lost and found.",
          "Lost and Found",
          "Main",
          "found",
          "Open",
          "2026-02-02",
          "XL size, leather material",
          ...
          "Open",
          "2026-02-01",
          "Yellow and blue cover",
          "https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg",
          2,

          "Gold Watch",
          "electronics",
          "Vintage gold watch. Still working.",
          "Cafeteria",
          "Waterloo",
          "found",
          "Open",
          "2026-01-31",
          "Gold face with leather strap",
      ...
      `,
        [
          "iPhone 13 Pro",
          "phone",
          "Lost iPhone 13 Pro, space gray color, likely near library or cafeteria",
          "Library/Cafeteria Area",
          "Main",
          "lost",
          "Reported",
          "2026-02-08",
          "Space gray with small crack on corner",
          2,
          "Canvas Messenger Bag",
          "bag",
          "Lost dark gray canvas messenger bag with my initials SJ embroidered",
          "Computer Lab",
          "Main",
          "lost",
          "Reported",
          "2026-02-07",
          "Dark gray with leather straps",
          4,
          "Gold Necklace",
          "electronics",
          "Lost gold chain necklace with small pendant in student center",
          "Student Center",
          "Waterloo",
          "lost",
          "Reported",
          "2026-02-06",
          "Delicate gold chain, small pendant",
          5,
        ],
      );
      ...
      `,
        [
          ...
          1,
          "verified",
          "Student verified ownership by providing AppleCare details",
          2,
          3,
          1,
          "pending",
          ...
          3,
          "verified",
          "ID verified by security member",
          5,
          5,
          4,
          "completed",
          "Item handed over to claimer",
          7,
          6,
          1,
          "rejected",
          "Claimer unable to provide proof of ownership",
          4,
          3,
          2,
          "pending",
